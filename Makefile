...
src :=  $(filter-out src/ariane_regfile.sv, $(wildcard src/*.sv))              \
        ...
        $(wildcard src/aes/*.v)                                        		   \
        $(wildcard src/aes/*.sv)                                       		   \
        $(wildcard src/sha256/*.v)                                    		   \
        $(wildcard src/sha256/*.sv)                                   		   \
        $(wildcard src/pkt/*.sv)                                       		   \
        $(wildcard src/fuse_mem/fuse_mem.sv)                           		   \
        $(wildcard src/acct/acct_wrapper.sv)                           		   \
	$(wildcard src/hmac/*.sv)                           		   \
        $(wildcard src/dma/*.sv)                                       		   \
        $(wildcard src/reglk/*.sv)                                    		   \
