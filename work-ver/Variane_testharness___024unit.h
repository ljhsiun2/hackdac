...
VL_MODULE(Variane_testharness___024unit) {
  ...
  public:
    ...
    void __Vdpiimwrap_debug_tick_TOP____024unit(CData/*0:0*/(&  debug_req_valid), const CData/*0:0*/ debug_req_ready, IData/*31:0*/(&  debug_req_bits_addr), IData/*31:0*/(&  debug_req_bits_op), IData/*31:0*/(&  debug_req_bits_data), const CData/*0:0*/ debug_resp_valid, CData/*0:0*/(&  debug_resp_ready), const IData/*31:0*/ debug_resp_bits_resp, const IData/*31:0*/ debug_resp_bits_data, IData/*31:0*/(&  debug_tick__Vfuncrtn));
